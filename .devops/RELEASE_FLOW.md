...
6. Validate the site at `https://vod.arkturian.com` (if applicable) and confirm fresh assets reached `/var/www/vod.arkturian.com`.

## Rollback Strategy
- Use `.devops/rollback.sh` on the server to restore from `/var/backups/vod-server-*`.
